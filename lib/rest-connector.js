...
function RestConnector(baseURL, settings) {
    ...
    var restTemplates = this._settings.restTemplates || {};
    var self = this;
    self.restTemplates = {};
    Object.keys(restTemplates).forEach(function (method) {
        var tempalte = new JsonTemplate(restTemplates[method]);
        self.restTemplates[method] = tempalte;
    });
