...
RestResource.prototype.create = function(obj, options, cb) {
  ...
  var template = this.connector.templates['create'];
...
RestResource.prototype.updateAll = function(query, obj, options, cb) {
  ...
  var template = this.connector.templates['updateAll'];
  var req = this.build(template, {
    qs: query,
    body: obj,
    callContext: options,
...
RestResource.prototype.update = function(id, obj, options, cb) {
  ...
  var template = this.connector.templates['update'];
  var req = this.build(template, {
    callContext: options,
    id: id,
    body: obj,
...
RestResource.prototype.delete = function(id, options, cb) {
  ...
  var template = this.connector.templates['deleteById'];
  var req = this.build(template, {
    id: id,
    callContext: options,
  });
...
RestResource.prototype.deleteAll = function(options, cb) {
  ...
  var template = this.connector.templates['deleteAll'];
  var req = this.build(template, {
    callContext: options,
  });
...
RestResource.prototype.find = function(id, options, cb) {
  ...
  var template = this.connector.templates['findById'];
  var req = this.build(template, {
    id: id,
    callContext: options,
  });
...
RestResource.prototype.all = RestResource.prototype.query = function(q, options, cb) {
  ...
  var template = this.connector.templates['query'];
  var req = this.build(template, {
    callContext: options,
    qs: q,
  });
